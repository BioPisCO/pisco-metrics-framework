...
var xhtml = './views/selectedcomponents.html';
var encoding = 'utf8';

var docSource = fs.readFileSync('schema/selectedcomponents.xml', encoding);  
var stylesheetSource = fs.readFileSync('schema/selectedcomponents.xsl', encoding);
